...
class Main:
    ...
    def getDecision(self):
        ...
        if decision >= 0:                                                       #011
            decision = round(decision/self.oh["bblind"])                        #011
        print(f'decision: {decision}\n')

        for i in range(6):                                                      #011
            playerchairstr = str(i)                                             #011
            myplayername=OpenHoldem.getPlayerName(playerchairstr)               #011    
            print(f'Chair {playerchairstr} name={myplayername}\n')              #011
